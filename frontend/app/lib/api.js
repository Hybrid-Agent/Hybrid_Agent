...
export const api = {
  ...
  payStellar: (listingId, method) => request(`/listings/${listingId}/pay/stellar`, { method: 'POST', body: { method } }),
  ...
  incomingPurchaseRequests: () => request('/listings/purchase-requests/incoming'),
  // chat
